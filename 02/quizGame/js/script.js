...
const setUpQuiz = () => {
	...
	// キャラクター画像の出力とセリフの変更
	studentImg.setAttribute('src', 'img/hamster_kurushii.png');
...
const correctJudge = (e) => {
	if (quiz[quizIndex].correct === e.target.textContent) {
		// キャラクター画像の変更
		studentImg.setAttribute('src', 'img/hamster_happy.png');
		// セリフの変更
		...
		// キャラクター画像の変更
		studentImg.setAttribute('src', 'img/hamster_sick.png');
		// セリフの変更
...
if (score>=7){//7問以上はよくできました
			...
			teacherword.innerHTML = "おめでとう！"
				...
				// キャラクター画像の変更
				studentImg.setAttribute('src', 'img/hamster_normal.png');
				// セリフの変更
